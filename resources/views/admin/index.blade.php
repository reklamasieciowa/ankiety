                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p>Pytań: {{ $survey->questions->count() }}</p>
                              ...
                              <p>Link pl: <a href="{{ route('survey.start', ['locale' => 'pl', 'survey' => $survey->id]) }}" target="_blank">{{ route('survey.start', ['locale' => 'pl', 'survey' => $survey->id]) }}</a></p>
                              <p>Link en: <a href="{{ route('survey.start', ['locale' => 'en', 'survey' => $survey->id]) }}" target="_blank">{{ route('survey.start', ['locale' => 'en', 'survey' => $survey->id]) }}</a></p>
                            <hr>
    ...
    <div class="row mt-4">
        ...
        <div class="col-xs-12 col-lg-3">
            <div class="card">
                ...
                <a class="btn btn-accent btn-sm" href="{{ route('admin.questions.create') }}">
