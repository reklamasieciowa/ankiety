   ...
   <div class="container-fluid">
    <div class="container">
      ...
      <div class="row mt-5 text-center">
        <div class="col-lg-12">
          <h1 class="h2-responsive title">Edytuj kategorię: {{ $category->name }}</h1>
       </div>
     </div>
          ...
          <div class="card-body">
            <form method="POST" action="{{ route('admin.category.update', ['category' => $category->id]) }}">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="name_pl" name="name_pl" value="{{ old('name_pl') ?? $category->name }}">
              </div>
              <div class="form-group">
