...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $survey = App\Survey::create([
            'finished' => 0,
            'pl'  => ['title' => 'Ogólnopolskie Badanie Kompetencji HR Biznes Partnerów 2019', 'description' => '<p><strong>CZY HR SPEŁNIA DZISIEJSZE OCZEKIWANIA BIZNESU?</strong></p>
            <p><strong>Pomóż ocenić najważniejsze kompetencje HR.</strong></p>
            ...
            <p>W tym krótkim formularzu (około 12 min) znajdziesz opisy konkretnych zachowań najbardziej pożądanych u biznesowego HRowca oraz skalę oceny. W pierwszej kolejności zapoznaj się ze skalą – ułatwi Ci to ocenę. Wypełniając formularz, oceń w jaki sposób Twój HR prezentuje te zachowania we współpracy z Tobą. Jeśli nie współpracujesz obecnie z HRBP lub HR, możesz odnieść się do swoich doświadczeń z poprzednich miejsc pracy.</p>
