                ...
                <div class="col-lg-6 my-3">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('admin.survey.show', ['survey' => $survey]) }}">{{ $survey->title }} @if($survey->company) - {{ $survey->company->name }}@endif</a>
                        </div>
                        <div class="card-body">
                            <p>Pytań: {{ $survey->questions->count() }} | Kategorii: {{ $survey->categories->count() }}</p>
                              <p>Ankietowanych: {{ $survey->people->count() }} | Odpowiedzi: {{ $survey->answers->count() }}</p>

                              <p>Pytania z odpowiedziami: {{ $survey->percentAnswered() }}</p>
                              <p>Ankiety niepełne: {{ $survey->peopleUnfinished() }} | Puste: {{ $survey->peopleWithoutAnswersCount() }} </p>
