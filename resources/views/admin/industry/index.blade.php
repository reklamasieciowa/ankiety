...
<div class="container-fluid">
  <div class="container">
    ...
    <div class="row mt-5 text-center">
      <div class="col-lg-12">
         <h1 class="h2-responsive title">Branże: {{ $industries->count() }}</h1>
              ...
              <div class="card-body">
                  ...
                  @forelse($industries as $industry)
                    <div class="row question_prev">
                      ...
                      <div class="col-lg-7">
                        <p><strong>Nazwa PL: </strong>{{ $industry->name }}</p>
                        <p><strong>Nazwa EN: </strong>{{ $industry->{'name:en'} }}</p>
                      </div>
                      <div class="col-lg-2">
                        <a class="btn btn-accent btn-sm" href="{{ route('admin.industry.edit', ['industry' => $industry->id ]) }}">
                            Edytuj <i class="fas fa-edit"></i>
                          </a>
                      </div>
                      <div class="col-lg-2">
                        <form method="POST" action="{{ route('admin.industry.destroy', ['industry' => $industry->id ]) }}">
                          @csrf
                          @method('DELETE')
