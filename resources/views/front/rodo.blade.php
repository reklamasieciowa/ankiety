...
<div class="container-fluid">
  ...
  <div class="row my-5 text-center">
    <div class="col-lg-12">
      @if (App::isLocale('pl'))
        <a href="{{ route('front.rodo', ['locale' => 'en']) }}" class="btn btn-accent">Swith to english</a>
      @else
        <a href="{{ route('front.rodo', ['locale' => 'pl']) }}" class="btn btn-accent">Zmień na polski</a>
      @endif
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-12 text-center">
        <section class="my-5">
          <h1 class="h3-responsive title">{{ config('app.name') }}</h1>
          <h2 class="h4-responsive title">{{ __('messages.Policy') }}</h2>
        </section>
